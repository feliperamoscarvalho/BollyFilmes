...
public class FilmesAdapter extends CursorAdapter{
    ...
    public FilmesAdapter (Context context, Cursor cursor){
        super(context, cursor, 0); //o último parâmetro é uma flag para mudar o comportamento padrão do adapter, 0 é o comportamento padrão
    }
    ...
    /*@NonNull
    @Override
    //Substituído pelo CursorAdapter (método bindView)
