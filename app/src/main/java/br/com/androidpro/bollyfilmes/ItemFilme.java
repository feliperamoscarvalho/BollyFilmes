...
public class ItemFilme implements Serializable{
    //O serializable é para permitir transportar como parâmetro um objeto de uma classe para outra
    private long id;
    ...
    public String getDataLancamento() {
        //Formata a data, se der algum erro, retorna ela no formato que veio mesmo
